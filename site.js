const translations = {
  es: {
    ...
    "properties.pedro1.name": "Pedro II el Catolico 3 - 1 IZQ",
    "properties.pedro1.area": "Universidad - Pedro II el Catolico",
    "properties.pedro1.copy": "Piso amueblado en Pedro II el Catolico 3, preparado para estancias de media duracion en Zaragoza.",
    "properties.pedro1.details": "Primero izquierda en una ubicacion urbana y bien comunicada, con cocina equipada, zona de trabajo y gestion local Ebrostay.",
    "properties.pedro2.name": "Pedro II el Catolico 3 - 2 IZQ",
    "properties.pedro2.area": "Universidad - Pedro II el Catolico",
    "properties.pedro2.copy": "Segundo izquierda en el mismo edificio, una opcion practica para profesionales, estudiantes o traslados temporales.",
    "properties.pedro2.details": "Vivienda amueblada con distribucion funcional, wifi, calefaccion y soporte local para llegada y estancia.",
    "properties.movera0.name": "Movera 7 - Planta Baja",
    "properties.movera0.area": "Movera",
    "properties.movera0.copy": "Piso en planta baja en Movera 7, pensado para estancias tranquilas con acceso comodo.",
    ...
    "form.propertyPlaceholder": "Pedro II el Catolico 3, Movera 7...",
  ...
  en: {
    ...
    "properties.pedro1.name": "Pedro II el Catolico 3 - 1 IZQ",
    "properties.pedro1.area": "University - Pedro II el Catolico",
    "properties.pedro1.copy": "Furnished flat at Pedro II el Catolico 3, prepared for medium-stay rentals in Zaragoza.",
    ...
    "properties.pedro2.name": "Pedro II el Catolico 3 - 2 IZQ",
    "properties.pedro2.area": "University - Pedro II el Catolico",
    ...
    "properties.movera0.name": "Movera 7 - Ground Floor",
    "properties.movera0.area": "Movera",
