...
const translations = {
  es: {
    ...
    "about.copy3": "Esta página es provisional: pronto añadiremos el equipo, nuestra historia y fotos. ¿Hablamos? Escríbenos a info@ebrostay.com.",
    ...
    "book.payNow": "Pagas ahora (1er mes)",
    "book.stay": "Estancia",
    "book.button": "Reservar y pagar",
    "book.note": "Pagas el primer mes para confirmar la reserva. La fianza y los meses siguientes se gestionan directamente con Ebrostay.",
    ...
    "auth.signupCopy": "Guarda viviendas favoritas y consulta tus reservas desde cualquier dispositivo.",
  ...
  en: {
    ...
    "about.copy3": "This page is a placeholder: team, story, and photos are coming soon. Want to talk? Write to info@ebrostay.com.",
    ...
    "book.payNow": "Pay now (first month)",
    "book.stay": "Stay",
    "book.button": "Book and pay",
    "book.note": "You pay the first month to confirm the booking. Deposit and following months are handled directly with Ebrostay.",
    ...
    "auth.signupCopy": "Save favorite homes and check your bookings from any device.",
